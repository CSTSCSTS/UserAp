import { USER_NAME_MAX_LENGTH, PASSWORD_MAX_LENGTH } from './PokerConstNumber.js';
...
const userNameExceedMaxLengthMessage = "ユーザー名が" + USER_NAME_MAX_LENGTH + "文字を超えています。";
const passwordExceedMaxLengthMessage = "パスワードが" + PASSWORD_MAX_LENGTH + "文字を超えています。";
