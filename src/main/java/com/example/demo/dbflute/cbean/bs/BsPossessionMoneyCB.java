 ...
 */
public class BsPossessionMoneyCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected PossessionMoneyCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsPossessionMoneyCB() {
     ...
     */
    public PossessionMoneyCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public PossessionMoneyCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected PossessionMoneyCQ doGetConditionQuery() {
    ...
    protected PossessionMoneyCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected PossessionMoneyCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        PossessionMoneyCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected PossessionMoneyCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new PossessionMoneyCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<PossessionMoneyCB> unionCBLambda) {
        final PossessionMoneyCB cb = new PossessionMoneyCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final PossessionMoneyCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<PossessionMoneyCB> unionCBLambda) {
        final PossessionMoneyCB cb = new PossessionMoneyCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final PossessionMoneyCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<PossessionMoneyCQ> {
         ...
         */
        public HpSDRFunction<PossessionMoneyCB, PossessionMoneyCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<PossessionMoneyCB> sq, PossessionMoneyCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public PossessionMoneyCB dreamCruiseCB() {
        PossessionMoneyCB cb = new PossessionMoneyCB();
        cb.xsetupForDreamCruise((PossessionMoneyCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<PossessionMoneyCB> columnQuery(final SpecifyQuery<PossessionMoneyCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected PossessionMoneyCB xcreateColumnQueryCB() {
        PossessionMoneyCB cb = new PossessionMoneyCB();
        cb.xsetupForColumnQuery((PossessionMoneyCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<PossessionMoneyCB> orCBLambda) {
        xorSQ((PossessionMoneyCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<PossessionMoneyCB> andCBLambda) {
        xorSQAP((PossessionMoneyCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final PossessionMoneyCB cb;
        if (mainCB != null) {
            cb = (PossessionMoneyCB)mainCB;
        } else {
            cb = new PossessionMoneyCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return PossessionMoneyCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return PossessionMoneyCQ.class.getName(); }
