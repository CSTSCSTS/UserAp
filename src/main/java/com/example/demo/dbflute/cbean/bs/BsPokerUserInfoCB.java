 ...
 */
public class BsPokerUserInfoCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected PokerUserInfoCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsPokerUserInfoCB() {
     ...
     */
    public PokerUserInfoCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public PokerUserInfoCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected PokerUserInfoCQ doGetConditionQuery() {
    ...
    protected PokerUserInfoCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected PokerUserInfoCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        PokerUserInfoCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected PokerUserInfoCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new PokerUserInfoCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<PokerUserInfoCB> unionCBLambda) {
        final PokerUserInfoCB cb = new PokerUserInfoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final PokerUserInfoCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<PokerUserInfoCB> unionCBLambda) {
        final PokerUserInfoCB cb = new PokerUserInfoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final PokerUserInfoCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<PokerUserInfoCQ> {
         ...
         */
        public HpSDRFunction<PokerUserInfoCB, PokerUserInfoCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<PokerUserInfoCB> sq, PokerUserInfoCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public PokerUserInfoCB dreamCruiseCB() {
        PokerUserInfoCB cb = new PokerUserInfoCB();
        cb.xsetupForDreamCruise((PokerUserInfoCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<PokerUserInfoCB> columnQuery(final SpecifyQuery<PokerUserInfoCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected PokerUserInfoCB xcreateColumnQueryCB() {
        PokerUserInfoCB cb = new PokerUserInfoCB();
        cb.xsetupForColumnQuery((PokerUserInfoCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<PokerUserInfoCB> orCBLambda) {
        xorSQ((PokerUserInfoCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<PokerUserInfoCB> andCBLambda) {
        xorSQAP((PokerUserInfoCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final PokerUserInfoCB cb;
        if (mainCB != null) {
            cb = (PokerUserInfoCB)mainCB;
        } else {
            cb = new PokerUserInfoCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return PokerUserInfoCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return PokerUserInfoCQ.class.getName(); }
