...
/**
 * The abstract condition-query of OAUTH_POKER_USER_INFO.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsOauthPokerUserInfoCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsOauthPokerUserInfoCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<OauthPokerUserInfoCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, OauthPokerUserInfoCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<OauthPokerUserInfoCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, OauthPokerUserInfoCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<OauthPokerUserInfoCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, OauthPokerUserInfoCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<OauthPokerUserInfoCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, OauthPokerUserInfoCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<OauthPokerUserInfoCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, OauthPokerUserInfoCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;OauthPokerUserInfoCB&gt;() {
     *     public void query(OauthPokerUserInfoCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<OauthPokerUserInfoCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, OauthPokerUserInfoCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        OauthPokerUserInfoCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(OauthPokerUserInfoCQ sq);

    protected OauthPokerUserInfoCB xcreateScalarConditionCB() {
        OauthPokerUserInfoCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected OauthPokerUserInfoCB xcreateScalarConditionPartitionByCB() {
        OauthPokerUserInfoCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<OauthPokerUserInfoCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        OauthPokerUserInfoCB cb = new OauthPokerUserInfoCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "USER_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(OauthPokerUserInfoCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<OauthPokerUserInfoCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(OauthPokerUserInfoCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        OauthPokerUserInfoCB cb = new OauthPokerUserInfoCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "USER_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(OauthPokerUserInfoCQ sq);
     ...
     */
    public void myselfExists(SubQuery<OauthPokerUserInfoCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        OauthPokerUserInfoCB cb = new OauthPokerUserInfoCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(OauthPokerUserInfoCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected OauthPokerUserInfoCB newMyCB() {
        return new OauthPokerUserInfoCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return OauthPokerUserInfoCQ.class.getName(); }
